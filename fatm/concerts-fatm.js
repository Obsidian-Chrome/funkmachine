...
async function loadConcertsData() {
    try {
        const response = await fetch('../data/concerts_fatm.json');
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (concertsData && Array.isArray(concertsData) && concertsList) {
        const sortedConcerts = sortConcerts(concertsData);
